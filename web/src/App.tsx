...
/**
 * Fase 0: la pantalla no tiene dominio todavía. Recorre la cadena entera
 * —navegador → proxy → api → Postgres— y enseña el resultado.
 *
 * La sonda del criterio A4 vivía aquí y se retiró al pasar A4: era un
 * instrumento de medición, no funcionalidad. El login llega en D1.
 */
